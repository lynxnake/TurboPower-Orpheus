...
// (DO NOT EDIT: machine generated header) 'ovcfsc.pas' rev: 26.00 (Windows)
...
protected:
	...
	void __fastcall fscDrawLine(const System::Types::TPoint &P1, const System::Types::TPoint &P2, const bool Up, TOvcFlatSpinnerLineType LineType);
	...
	void __fastcall fscPolyline(System::Types::TPoint const *Points, const int Points_Size);
