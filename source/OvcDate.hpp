...
// (DO NOT EDIT: machine generated header) 'ovcdate.pas' rev: 26.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall DateTimeDiff(const TStDateTimeRec &DT1, TStDateTimeRec &DT2, int &Days, int &Secs);
...
extern DELPHI_PACKAGE void __fastcall IncDateTime(const TStDateTimeRec &DT1, TStDateTimeRec &DT2, int Days, int Secs);
