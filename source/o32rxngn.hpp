...
// (DO NOT EDIT: machine generated header) 'o32rxngn.pas' rev: 26.00 (Windows)
...
#include <o32intdeq.hpp>	// Pascal unit
#include <o32intlst.hpp>	// Pascal unit
#include <O32WideCharSet.hpp>	// Pascal unit
