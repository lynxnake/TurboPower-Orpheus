...
// (DO NOT EDIT: machine generated header) 'ovcRTF_RichOle.pas' rev: 26.00 (Windows)
...
public:
	...
	virtual HRESULT __stdcall QueryAcceptData(const _di_IDataObject dataobj, System::Word &cfFormat, unsigned reco, BOOL fReally, NativeUInt hMetaPict) = 0 ;
	virtual HRESULT __stdcall ContextSensitiveHelp(BOOL fEnterMode) = 0 ;
	virtual HRESULT __stdcall GetClipboardData(const CHARRANGE &chrg, unsigned reco, /* out */ _di_IDataObject &dataobj) = 0 ;
