...
// (DO NOT EDIT: machine generated header) 'ovcstr.pas' rev: 26.00 (Windows)
...
extern DELPHI_PACKAGE bool __fastcall StrToLongPChar(System::WideChar * S, int &I);
...
extern DELPHI_PACKAGE bool __fastcall ovcCharInSet(System::WideChar C, const System::Sysutils::TSysCharSet &CharSet);
