...
// (DO NOT EDIT: machine generated header) 'ovcef.pas' rev: 26.00 (Windows)
...
#include <ovcuser.hpp>	// Pascal unit
#include <ovcdate.hpp>	// Pascal unit
...
protected:
	...
	bool __fastcall efBinStr2Long(System::WideChar * St, int &L);
	...
	bool __fastcall efOctStr2Long(System::WideChar * St, int &L);
	...
	bool __fastcall efStr2Long(System::WideChar * P, int &L);
