...
// (DO NOT EDIT: machine generated header) 'ovcRTF_TOM.pas' rev: 26.00 (Windows)
...
typedef BOOL __stdcall (*TTxDrawCallback)(unsigned param);
...
public:
	...
	virtual HRESULT __stdcall TxGetHScroll(/* out */ int &plMin, /* out */ int &plMax, /* out */ int &plPos, /* out */ int &plPage, /* out */ BOOL &pfEnabled) = 0 ;
	virtual HRESULT __stdcall TxGetVScroll(/* out */ int &plMin, /* out */ int &plMax, /* out */ int &plPos, /* out */ int &plPage, /* out */ BOOL &pfEnabled) = 0 ;
...
public:
	...
	virtual BOOL __stdcall TxShowScrollBar(int fnBar, BOOL fShow) = 0 ;
	virtual BOOL __stdcall TxEnableScrollBar(int fuSBFlags, int fuArrowFlags) = 0 ;
	virtual BOOL __stdcall TxSetScrollRange(int fnBar, int nMinPos, int nMaxPos, BOOL fRedraw) = 0 ;
	virtual BOOL __stdcall TxSetScrollPos(int fnBar, int nPos, BOOL fRedraw) = 0 ;
	virtual void __stdcall TxInvalidateRect(const System::Types::TRect &prc, BOOL fMode) = 0 ;
	virtual void __stdcall TxViewChange(BOOL fUpdate) = 0 ;
	virtual BOOL __stdcall TxCreateCaret(HBITMAP hbmp, int xWidth, int yHeight) = 0 ;
	virtual BOOL __stdcall TxShowCaret(BOOL fShow) = 0 ;
	virtual BOOL __stdcall TxSetCaretPos(int x, int y) = 0 ;
	virtual BOOL __stdcall TxSetTimer(unsigned idTimer, unsigned uTimeout) = 0 ;
	...
	virtual void __stdcall TxSetCapture(BOOL fCapture) = 0 ;
	virtual void __stdcall TxSetFocus(void) = 0 ;
	virtual void __stdcall TxSetCursor(HICON hcur, BOOL fText) = 0 ;
	virtual BOOL __stdcall TxScreenToClient(System::Types::TPoint &lppt) = 0 ;
	virtual BOOL __stdcall TxClientToScreen(System::Types::TPoint &lppt) = 0 ;
...
public:
	...
	virtual BOOL __stdcall TxShowScrollBar(int fnBar, BOOL fShow);
	virtual BOOL __stdcall TxEnableScrollBar(int fuSBFlags, int fuArrowFlags);
	virtual BOOL __stdcall TxSetScrollRange(int fnBar, int nMinPos, int nMaxPos, BOOL fRedraw);
	virtual BOOL __stdcall TxSetScrollPos(int fnBar, int nPos, BOOL fRedraw);
	virtual void __stdcall TxInvalidateRect(const System::Types::TRect &prc, BOOL fMode);
	virtual void __stdcall TxViewChange(BOOL fUpdate);
	virtual BOOL __stdcall TxCreateCaret(HBITMAP hbmp, int xWidth, int yHeight);
	virtual BOOL __stdcall TxShowCaret(BOOL fShow);
	virtual BOOL __stdcall TxSetCaretPos(int x, int y);
	virtual BOOL __stdcall TxSetTimer(unsigned idTimer, unsigned uTimeout);
	...
	virtual void __stdcall TxSetCapture(BOOL fCapture);
	virtual void __stdcall TxSetFocus(void);
	virtual void __stdcall TxSetCursor(HICON hcur, BOOL fText);
	virtual BOOL __stdcall TxScreenToClient(System::Types::TPoint &lppt);
	virtual BOOL __stdcall TxClientToScreen(System::Types::TPoint &lppt);
