...
// (DO NOT EDIT: machine generated header) 'ovcdbhll.pas' rev: 26.00 (Windows)
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE void __fastcall OvcFindNearestKey(TOvcDbEngineHelperBase* aHelper, Data::Db::TDataSet* aDataSet, System::TVarRec const *aKeyValues, const int aKeyValues_Size);
