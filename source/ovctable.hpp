...
// (DO NOT EDIT: machine generated header) 'ovctable.pas' rev: 26.00 (Windows)
...
#include <ovctcary.hpp>	// Pascal unit
#include <ovctsell.hpp>	// Pascal unit
#include <ovctcell.hpp>	// Pascal unit
#include <ovctchdr.hpp>	// Pascal unit
#include <ovctgpns.hpp>	// Pascal unit
#include <ovctbclr.hpp>	// Pascal unit
#include <ovctbrws.hpp>	// Pascal unit
#include <ovctbcls.hpp>	// Pascal unit
#include <ovcdrag.hpp>	// Pascal unit
...
{
//-- type declarations -------------------------------------------------------
typedef System::Uitypes::TScrollStyle TScrollStyle;
